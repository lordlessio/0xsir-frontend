<template>
  <transition name="sir-hide-fade" @enter="enter">
    <div v-if="visible" class="TTFontBold sir-loading-box" @touchmove.prevent>
      <p class="loading-icon"></p>
      <p class="text-center loading-text">Analyzing...<br>
        <!-- <span>Blocklens...</span> -->
      </p>
    </div>
  </transition>
